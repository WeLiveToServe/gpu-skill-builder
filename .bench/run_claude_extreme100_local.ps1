...
python .\run_named_suite.py --harness claude --suites extreme100 --timeout-s 1200 --ledger .\suite_runs_claude_extreme100_gpu.json 2>&1 | Tee-Object -FilePath $log -Append
